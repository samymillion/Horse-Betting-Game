...
DISTDIR = /mnt/c/school\ files\ 2023-24/cs\ 3307/pixelderby/.tmp/startRace1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
distdir: FORCE
	...
	$(COPY_FILE) --parents startRace.cpp $(DISTDIR)/
